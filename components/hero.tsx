        ...
        <section id="home" className="relative min-h-screen flex items-center bg-coffee-dark pt-16">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
                ...
                <div className="text-center max-w-4xl mx-auto mb-16">
                    <div
                        className="inline-flex items-center gap-2 px-4 py-2 bg-gold/20 rounded-full text-gold text-sm font-medium mb-6">
                    ...
                    <p className="text-lg text-white/80 leading-relaxed mb-8 max-w-2xl mx-auto">
                        Your gateway to mastering Chinese and foreign languages. With the rise of Chinese and foreign
                        investors worldwide, there is a growing demand for skilled language interpreters. We prepare you
                        for success in this expanding global market.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button
                            asChild
                            size="lg"
                            className="bg-gold hover:bg-gold-dark text-coffee-dark font-semibold text-base px-8"
                        >
                        ...
                        <Button
                            ...
                            size="lg"
                            variant="outline"
                            className="border-gold text-gold hover:bg-gold hover:text-coffee-dark font-semibold text-base px-8 bg-transparent"
                        >
                        ...
                        <Button
                            asChild
                            size="lg"
                            className="bg-transparent border border-gold text-gold hover:bg-gold hover:text-coffee-dark font-semibold text-base px-6"
                        >
                            <Link
                                href="https://g.page/r/CWj7CNtZbpO9EBM/review"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                ⭐⭐⭐ Leave a Review for Zimgro Services
                            </Link>
                        </Button>
                    </div>
