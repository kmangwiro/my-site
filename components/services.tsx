      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-coffee rounded-3xl p-8 sm:p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {/* Exam Dates */}
            <Card className="h-full rounded-2xl border border-gold/30 bg-white/5 shadow-md hover:shadow-xl transition-shadow">
              <CardHeader>
            ...
            <Card className="h-full rounded-2xl border border-gold/30 bg-white/5 shadow-md hover:shadow-xl transition-shadow">
              <CardHeader>
                <CardTitle className="text-gold text-lg font-bold">
                  Examination Fees
                </CardTitle>
                <CardDescription className="text-white/70 text-sm">
                  Official exam fees
              ...
              <CardContent className="space-y-1 text-white/80 text-sm">
                ...
                <div className="text-white/70 mt-2 p-2 bg-gold/20 rounded text-xs">
                  Note: An additional $5 administrative fee applies to all
                  registrations.
                </div>
              </CardContent>
            </Card>
          ...
          {/* Registration Form */}
          <div className="mt-12 bg-white/10 p-8 rounded-3xl shadow-lg max-w-7xl mx-auto">
            <h3 className="text-2xl font-bold text-gold mb-3 text-center">
              Preliminary Registration
            </h3>
            <p className="text-white/70 mb-6 text-center">
              Fill in your details below and send them directly to WhatsApp for
              preliminary registration.
            </p>
            ...
            <form
              onSubmit={(e) => {
                ...
                const message = `Preliminary Registration:\nFull Name: ${fullName}\nID Number: ${idNumber}\nPhone: ${phone}\nEmail: ${email}`;
                const whatsappURL = `https://wa.me/263786409822?text=${encodeURIComponent(
                  message
                )}`;
